...
class QualificationsControllerTest < ActionController::TestCase
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post :create, qualification: { industry: @qualification.industry, name: @qualification.name, subdivision: @qualification.subdivision }
    end
  ...
  test "should update qualification" do
    put :update, id: @qualification, qualification: { industry: @qualification.industry, name: @qualification.name, subdivision: @qualification.subdivision }
    assert_redirected_to qualification_path(assigns(:qualification))
  end
